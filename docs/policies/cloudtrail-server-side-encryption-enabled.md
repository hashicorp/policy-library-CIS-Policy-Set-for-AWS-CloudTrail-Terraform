...
This rule is covered by the [cloudtrail-server-side-encryption-enabled](https://github.com/hashicorp/policy-library-cis-aws-cloudtrail-terraform/blob/main/policies/cloudtrail-server-side-encryption-enabled.sentinel) policy.
